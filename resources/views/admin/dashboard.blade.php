...
class="min-h-screen bg-gray-50 font-sans antialiased">
...
<aside class="w-80 bg-white border-r border-gray-200 flex flex-col shadow-sm">
    ...
    {{-- BRAND --}}
    <div class="h-24 flex items-center px-8 border-b bg-gradient-to-r from-blue-600 to-indigo-700">
        <div>
    ...
    <nav class="flex-1 overflow-y-auto px-6 py-6 space-y-3 text-base">
        ...
        <a href="{{ $safe('admin.system.index') }}"
        ...
        <a href="{{ $safe('admin.settings.index') }}"
...
<div class="bg-white p-10 rounded-2xl border shadow-sm flex justify-between items-center">
    ...
    <div>
        @if(empty($platformMeta))
            <a href="{{ $safe('admin.meta.connect') }}"
