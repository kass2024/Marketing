    ...
    <nav class="flex-1 overflow-y-auto px-6 py-6 space-y-3 text-base">
        ...
        <div>
            ...
            <div x-show="openAds" x-transition class="pl-6 mt-2 space-y-2">
                <a href="{{ safeRoute('admin.accounts.index') }}" class="block py-2 px-3 rounded-lg hover:bg-gray-100 {{ str_contains($route,'admin.accounts')?'text-blue-600 font-semibold':'' }}">Ad Accounts</a>
                <a href="{{ safeRoute('admin.campaigns.index') }}" class="block py-2 px-3 rounded-lg hover:bg-gray-100 {{ str_contains($route,'admin.campaigns')?'text-blue-600 font-semibold':'' }}">Campaigns</a>
                <a href="{{ safeRoute('admin.ads.index') }}" class="block py-2 px-3 rounded-lg hover:bg-gray-100 {{ str_contains($route,'admin.ads')?'text-blue-600 font-semibold':'' }}">Ads & Creatives</a>
                <a href="{{ safeRoute('admin.analytics.index') }}" class="block py-2 px-3 rounded-lg hover:bg-gray-100 {{ str_contains($route,'admin.analytics')?'text-blue-600 font-semibold':'' }}">Insights & Reports</a>
            </div>
        </div>
        ...
        <div>
            ...
            <div x-show="openSocial" x-transition class="pl-6 mt-2 space-y-2">
                <a href="{{ safeRoute('admin.instagram.index') }}" class="block py-2 px-3 rounded-lg hover:bg-gray-100 {{ str_contains($route,'admin.instagram')?'text-blue-600 font-semibold':'' }}">Instagram</a>
                <a href="{{ safeRoute('admin.messenger.index') }}" class="block py-2 px-3 rounded-lg hover:bg-gray-100 {{ str_contains($route,'admin.messenger')?'text-blue-600 font-semibold':'' }}">Messenger</a>
                <a href="{{ safeRoute('admin.whatsapp.index') }}" class="block py-2 px-3 rounded-lg hover:bg-gray-100 {{ str_contains($route,'admin.whatsapp')?'text-blue-600 font-semibold':'' }}">WhatsApp</a>
            </div>
        </div>
        ...
        <div>
            ...
            <div x-show="openAutomation" x-transition class="pl-6 mt-2 space-y-2">
                <a href="{{ route('admin.chatbots.index') }}" class="block py-2 px-3 rounded-lg hover:bg-gray-100 {{ str_contains($route,'admin.chatbots')?'text-blue-600 font-semibold':'' }}">Chatbots</a>
                <a href="{{ route('admin.faq.index') }}" class="block py-2 px-3 rounded-lg hover:bg-gray-100 {{ str_contains($route,'admin.faq')?'text-blue-600 font-semibold':'' }}">FAQ Knowledge Base</a>
                <a href="{{ route('admin.faq.create') }}" class="block py-2 px-3 rounded-lg hover:bg-green-50 text-green-600 font-semibold">+ Add FAQ</a>
                <a href="{{ route('admin.templates.index') }}" class="block py-2 px-3 rounded-lg hover:bg-gray-100 {{ str_contains($route,'admin.templates')?'text-blue-600 font-semibold':'' }}">Templates</a>
                <a href="{{ route('admin.leads.index') }}" class="block py-2 px-3 rounded-lg hover:bg-gray-100 {{ str_contains($route,'admin.leads')?'text-blue-600 font-semibold':'' }}">Leads CRM</a>
            </div>
        </div>

        <a href="{{ safeRoute('admin.system.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-100 {{ str_contains($route,'admin.system')?'text-blue-600 font-semibold':'' }}">🛠 System Monitor</a>
        <a href="{{ safeRoute('admin.settings.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-100 {{ str_contains($route,'admin.settings')?'text-blue-600 font-semibold':'' }}">⚙️ Settings</a>
...
<div class="bg-white p-10 rounded-2xl border shadow-sm flex justify-between items-center">
    <div>
        ...
        @if(!empty($platformMeta))
            ...
            <p class="text-green-600 font-medium mt-2">Verified & Connected</p>
        @else
            <p class="text-red-500 mt-3">No business connected</p>
        @endif
    </div>
